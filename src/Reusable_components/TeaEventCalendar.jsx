...
import TeaEventDetailPopup from '../Dashboard/Teacher_Dashboard/TeaEvent/TeaEventDetailPopup';

const TeaEventCalendar = ({ events, initialView = "month" }) => {
...
export default TeaEventCalendar;
