...
const searchOptions = [
  ...
  return (
    <div className=' h-full mb-10 mr-2'>
      ...
      <p className=' mt-2'><NavLink to = '/admin'> Dashboard </NavLink>/<NavLink to = '/admin/hostel'> Hostel </NavLink>/ <span className='text-[#ffae01] font-semibold'>Hostel Rooms</span> </p>
