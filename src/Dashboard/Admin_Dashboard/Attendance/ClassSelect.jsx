...
const ClassAttendance = () => {
  ...
  return (
    ...
    <p className='mt-2'>Dashboard /<NavLink to = '/admin'> Admin </NavLink>/ <NavLink to='/admin/select'> Home  </NavLink>/  <span className='text-[#ffae01] font-semibold'>Classes</span> </p>
    <div className='mt-10'>
