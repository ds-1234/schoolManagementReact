...
const searchOptions = [
  ...
  return (
    <div className='pl-0 h-full mb-10'>
      ...
      <p className='pl-0 mt-2'><NavLink to = '/admin/user'> Dashboard </NavLink>/<NavLink to = '/admin/Examinations'> Examinations </NavLink>/ <span className='text-[#ffae01] font-semibold'>Grade</span> </p>
