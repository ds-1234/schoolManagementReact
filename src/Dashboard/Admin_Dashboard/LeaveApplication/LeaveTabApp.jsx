...
import LeaveCategory from "./LeaveCategoryApp"; // Assuming LeaveCategoryPage displays tables
...
const LeaveTab = () => {
  ...
  return (
    <div className="h-full mb-10">
      ...
      <p className="mt-2">
        Dashboard /<NavLink to="/admin"> Admin </NavLink>/ <span className="text-[#ffae01] font-semibold">Leaves</span>
      </p>
